...
const CONFIG = {
  // Range do calendário (12 linhas = meses, largura visual completa do quadro).
  // Inclui as colunas de folga; células vazias/texto são ignoradas na contagem.
  CALENDAR_RANGE: 'B5:AO16',
