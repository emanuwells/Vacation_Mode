...
## Integrações on-demand

As receitas atuais estão em `.agents/integrations/recipes/`: Context7, GitHub MCP read-only, Docker MCP Toolkit e Sentry MCP. Nenhuma é ativada automaticamente pelo projeto.
